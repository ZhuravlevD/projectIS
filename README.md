...
**4.3 Контекст:** A0 Машиностроительное производство
...
* **Триггер (событие, стартующее прецедент):** Необходимость анализа состояния оборудования/производственного процесса
...
![p5](https://github.com/ZhuravlevD/projectIS/blob/main/scr1/uml-component.png)
...
* Муда: Ручной сбор и анализ данных
